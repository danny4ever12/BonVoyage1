...
public partial class st_wy3 : System.Web.UI.Page
{
...
if (dnamet.HasRows)
{
    ...
    Button5.Text = "View customised pack";
        ...
        String str1 = "select SpotName from locations where HotelCode='wyb'";
        ...
        String str2 = "select description from locations where HotelCode='wyb'";
        ...
        String smin = "select min(pos) from imagespath where image_code='wyb'";
        ...
        String smax = "select max(pos) from imagespath where image_code='wyb'";
        ...
        String str3 = "select  path from imagespath where image_code='wyb' and pos='" + mintemp + "'";
        ...
        ++mintemp;
        String str4 = "select  path from imagespath where image_code='wyb' and pos='" + mintemp + "'";
        ...
        ++mintemp;
        String str5 = "select  path from imagespath where image_code='wyb' and pos='" + mintemp + "'";
        ...
        ++mintemp;
        String str6 = "select  path from imagespath where image_code='wyb' and pos='" + mintemp + "'";
        ...
        String sminhtl = "select min(pos) from imagespath where image_code='wyb'";
        ...
        String smaxhtl = "select max(pos) from imagespath where image_code='wyb'";
        ...
        String str7 = "select hotel_name from hotels where hotel_code='wyb' and pos='" + temp + "'";
        ...
        ++temp;
        String str8 = "select hotel_name from hotels where hotel_code='wyb' and pos='" + temp + "'";
        ...
        ++temp;
        String str9 = "select hotel_name from hotels where hotel_code='wyb' and pos='" + temp + "'";
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        String smin1 = "select min(pos) from rooms where room_code='wyb2'";
        OdbcCommand cmdmin1 = new OdbcCommand(smin1, con);
        OdbcDataReader drmin1 = cmdmin1.ExecuteReader();
        ...
        String smax1 = "select max(pos) from rooms where room_code='wyb2'";
        OdbcCommand cmdmax1 = new OdbcCommand(smax1, con);
        OdbcDataReader drmax1 = cmdmax1.ExecuteReader();
        ...
        String str1 = "select room from rooms where room_code='wyb2' and pos='" + mintemp1 + "'";
        OdbcCommand cmd1 = new OdbcCommand(str1, con);
        OdbcDataReader dr1 = cmd1.ExecuteReader();
        ...
        String str2 = "select facilities from rooms where room_code='wyb2' and pos='" + mintemp1 + "'";
        OdbcCommand cmd2 = new OdbcCommand(str2, con);
        OdbcDataReader dr2 = cmd2.ExecuteReader();
        ...
        String str3 = "select price_rate from rooms where room_code='wyb2' and pos='" + mintemp1 + "'";
        OdbcCommand cmd3 = new OdbcCommand(str3, con);
        OdbcDataReader dr3 = cmd3.ExecuteReader();
        ...
        ++mintemp1;
        String str4 = "select room from rooms where room_code='wyb2' and pos='" + mintemp1 + "'";
        OdbcCommand cmd4 = new OdbcCommand(str4, con);
        OdbcDataReader dr4 = cmd4.ExecuteReader();
        ...
        String str5 = "select facilities from rooms where room_code='wyb2' and pos='" + mintemp1 + "'";
        OdbcCommand cmd5 = new OdbcCommand(str5, con);
        OdbcDataReader dr5 = cmd5.ExecuteReader();
        ...
        String str6 = "select price_rate from rooms where room_code='wyb2' and pos='" + mintemp1 + "'";
        OdbcCommand cmd6 = new OdbcCommand(str6, con);
        OdbcDataReader dr6 = cmd6.ExecuteReader();
        ...
        ++mintemp1;
        String str7 = "select room from rooms where room_code='wyb2' and pos='" + mintemp1 + "'";
        OdbcCommand cmd7 = new OdbcCommand(str7, con);
        OdbcDataReader dr7 = cmd7.ExecuteReader();
        ...
        String str8 = "select facilities from rooms where room_code='wyb2' and pos='" + mintemp1 + "'";
        OdbcCommand cmd8 = new OdbcCommand(str8, con);
        OdbcDataReader dr8 = cmd8.ExecuteReader();
        ...
        String str9 = "select price_rate from rooms where room_code='wyb2' and pos='" + mintemp1 + "'";
        OdbcCommand cmd9 = new OdbcCommand(str9, con);
        OdbcDataReader dr9 = cmd9.ExecuteReader();
    ...
    protected void LinkButton3_Click(object sender, EventArgs e)
    {
        ...
        String smin1 = "select min(pos) from rooms where room_code='wyb3'";
        OdbcCommand cmdmin1 = new OdbcCommand(smin1, con);
        OdbcDataReader drmin1 = cmdmin1.ExecuteReader();
        ...
        String smax1 = "select max(pos) from rooms where room_code='wyb3'";
        OdbcCommand cmdmax1 = new OdbcCommand(smax1, con);
        OdbcDataReader drmax1 = cmdmax1.ExecuteReader();
        ...
        String str1 = "select room from rooms where room_code='wyb3' and pos='" + mintemp1 + "'";
        OdbcCommand cmd1 = new OdbcCommand(str1, con);
        OdbcDataReader dr1 = cmd1.ExecuteReader();
        ...
        String str2 = "select facilities from rooms where room_code='wyb3' and pos='" + mintemp1 + "'";
        OdbcCommand cmd2 = new OdbcCommand(str2, con);
        OdbcDataReader dr2 = cmd2.ExecuteReader();
        ...
        String str3 = "select price_rate from rooms where room_code='wyb3' and pos='" + mintemp1 + "'";
        OdbcCommand cmd3 = new OdbcCommand(str3, con);
        OdbcDataReader dr3 = cmd3.ExecuteReader();
        ...
        ++mintemp1;
        String str4 = "select room from rooms where room_code='wyb3' and pos='" + mintemp1 + "'";
        OdbcCommand cmd4 = new OdbcCommand(str4, con);
        OdbcDataReader dr4 = cmd4.ExecuteReader();
        ...
        String str5 = "select facilities from rooms where room_code='wyb3' and pos='" + mintemp1 + "'";
        OdbcCommand cmd5 = new OdbcCommand(str5, con);
        OdbcDataReader dr5 = cmd5.ExecuteReader();
        ...
        String str6 = "select price_rate from rooms where room_code='wyb3' and pos='" + mintemp1 + "'";
        OdbcCommand cmd6 = new OdbcCommand(str6, con);
        OdbcDataReader dr6 = cmd6.ExecuteReader();
        ...
        ++mintemp1;
        String str7 = "select room from rooms where room_code='wyb3' and pos='" + mintemp1 + "'";
        OdbcCommand cmd7 = new OdbcCommand(str7, con);
        OdbcDataReader dr7 = cmd7.ExecuteReader();
        ...
        String str8 = "select facilities from rooms where room_code='wyb3' and pos='" + mintemp1 + "'";
        OdbcCommand cmd8 = new OdbcCommand(str8, con);
        OdbcDataReader dr8 = cmd8.ExecuteReader();
        ...
        String str9 = "select price_rate from rooms where room_code='wyb3' and pos='" + mintemp1 + "'";
        OdbcCommand cmd9 = new OdbcCommand(str9, con);
        OdbcDataReader dr9 = cmd9.ExecuteReader();
    ...
    {
        con.Open();
        String htl = "select hotel_name from hotels where roomcode='wyb1'";
    ...
    {
        con.Open();
        String htl = "select hotel_name from hotels where roomcode='wyb2'";
        OdbcCommand cmd1 = new OdbcCommand(htl, con);
        OdbcDataReader dr1 = cmd1.ExecuteReader();
        dr1.Read();
    ...
    {
        con.Open();
        String htl = "select hotel_name from hotels where roomcode='wyb3'";
        OdbcCommand cmd1 = new OdbcCommand(htl, con);
        OdbcDataReader dr1 = cmd1.ExecuteReader();
        dr1.Read();
